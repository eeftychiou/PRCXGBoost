"""
This script handles the model training stage of the ML pipeline using RandomForest.

It uses a RandomForest Regressor to train a model on the feature-rich
